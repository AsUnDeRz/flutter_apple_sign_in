...
class _AppleSignInButtonState extends State<AppleSignInButton> {
  ...
  Widget build(BuildContext context) {
    final bgColor = widget.style == AppleButtonStyle.black ? Colors.black : Colors.white;
    final textColor = widget.style == AppleButtonStyle.black ? Colors.white : Colors.black;
    final borderColor = widget.style == AppleButtonStyle.white ? Colors.white : Colors.black;
          ...
          children: [
            Align(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(width: widget.applePaddingLeft),
                  Padding(
